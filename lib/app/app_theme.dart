...
enum AppKeyEnum {
  ...
  mainUp,
  optionsBack,
  optionsExpandRepeats,
  optionsFullScreen,
  optionsHoliday,
  optionsLeadership,
  optionsNinJam,
  optionsUserDisplayStyle,
  optionsUserName,
  optionsWebsocketBob,
  optionsWebsocketCJ,
  optionsWebsocketIP,
  ...
  songsAcceptAllSongReads,
  songsAcceptSongRead,
  songsBack,
  songsCancelSongAllAdds,
  songsErrorMessage,
  songsReadFiles,
  songsRejectSongRead,
  songsRemoveAll,
...
Map<AppKeyEnum, Type> appKeyEnumTypeMap = {
  ...
  AppKeyEnum.optionsExpandRepeats: String,
  AppKeyEnum.optionsUserName: String,
  AppKeyEnum.optionsUserDisplayStyle: String,
  ...
  //AppKeyEnum.playerKeyOffset: int,
