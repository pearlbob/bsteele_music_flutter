      ...
      body: DefaultTextStyle(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
              ...
              children: <Widget>[
                md.MarkdownBody(
                    styleSheet: md.MarkdownStyleSheet(textScaleFactor: isScreenBig ? 2 : 1),
                    data:
                        //  fixme: generate the chord descriptors
                    ...
                    //  the input but hide the wrap from the markup
                        ...
                        'A chordDescriptor is one of: '
                            ...
                            ' Suggestion: choose the button "Show All Chords" above to see all possible chords.\n'
                        '\n'
                        ...
                        '\n'
                        '# Repeats\n'
                        'A measure line that ends with a \'x\' and a number is a repeat. '
                        ...
                        'If a measure line ends with a vertical bar \'|\' it will be included with the following line'
                            ...
                            'This is consdered a legacy form that will be deprecated '
