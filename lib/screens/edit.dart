...
class AppContainedButton extends RaisedButton {
  AppContainedButton(String text,
        ...
        Row(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: TextField(
                  controller:
                  TextEditingController(text: song.copyright),
                  decoration: InputDecoration(
                      hintText:
                      'Enter the song\'s copyright. Required.'),
                  maxLength: 120,
                  style: _boldTextStyle,
                ),
              ),
        ...
        Container(
          ...
          child: Column(
              children: <Widget>[
                ...
                RichText(
                  text: TextSpan(children: <InlineSpan>[ TextSpan(text: '''Section types are followed by a colon (:).
                        ...
                        ''',
                    style: _textStyle,),
                    TextSpan(text: '''Sections with the same content will automatically be placed in the same declaration.
                        Row commas are not significant in the difference i.e. commas don't create a difference.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Chords ultimately must be in upper case. If they are not on entry, the app will try to guess
                   ...
                   ''',
                      style: _textStyle,),
                    TextSpan(text: '''A capital X is used to indicate no chord.
                    ''',
                      style: _textStyle,),
                    TextSpan(
                        text: '''Using a lower case b for a flat will work. A sharp sign (#) works as a sharp.''',
                      style: _textStyle,),
                    TextSpan(text: '''Notice that this can get problematic around the lower case b. Should the entry "bbm7"
                   ...
                   ''',
                      style: _textStyle,),
                    TextSpan(text: '''Limited set of case sensitive chord modifiers can be used: 7sus4,
                        7sus2,
                        7sus,
                        13,
                        11,
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Spaces between chords indicate a new measure. Chords without spaces are within one
                        measure.''',
                      style: _textStyle,),
                    TextSpan(text: '''Forward slashes (/) can be used to indicate bass notes that differ from the chord.
                   ...
                   ''',
                      style: _textStyle,),
                    TextSpan(text: '''Periods (.) can be used to repeat chords on another beat within the same meausure. For
                        example,
                        G..A would be three beats of G followed by one beat of A in the same measure.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Sample measures to use:
                        <ul>
                            <li>A B C G</li>
                            <li>A# C# Bb Db</li>
                   ...
                   ''',
                      style: _textStyle,),
                    TextSpan(text: '''Commas (,) between measures can be used to indicate the end of a row of measures.
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Minus signs (-) can be used to indicate a repeated measure. There must be a space before
                        and after it.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Row repeats are indicated by a lower case x followed by a number 2 or more.
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Comments are not allowed in the chord section.
                        Chord input not understood will be placed in parenthesis, eg. "(this is not a chord sequence)".
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Since you can enter the return key to format your entry, you must us the Enter button
                        to enter it into the song.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''The red bar or measure highlight indicate where entry text will be entered.
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Double click a measure to select it for replacement or deletion.
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Control plus the arrow keys can help navigate in the chord entry once selected.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''In the lyrics section, anything else not recognized as a section identifier is
                        considered lyrics to the end of the line.
                        I suggest comments go into parenthesis.
                   ''',
                      style: _textStyle,),
                    TextSpan(text: '''The buttons to the right of the displayed chords are active and there to minimize your typing.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''A trick: Select a section similar to a new section you are about to enter.
                    ...
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Another trick: Write the chord section as you like in a text editor, copy the whole song's
                        chords and paste into the entry line... complete with newlines. All should be well.
                    ''',
                      style: _textStyle,),
                    TextSpan(text: '''Don't forget the undo/redo keys! Undo will even go backwards into the previously edited song.
                      ''',
                      style: _textStyle,),
                  ],
                  ),),
