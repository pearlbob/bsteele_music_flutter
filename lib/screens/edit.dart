...
class _Edit extends State<Edit> {
    ...
    if (value.runtimeType == RawKeyDownEvent) {
      ...
      if (e.isControlPressed) {
        ...
        setState(() {
          _editMeasure();
          //  assure end of row
          _getLocationMeasure(_song.getCurrentChordSectionLocation())?.endOfRow = true;
        });
  ...
  Widget _measureEditGridDisplayWidget(_EditDataPoint editDataPoint) {
    ...
    if (_selectedEditDataPoint == editDataPoint) {
      ...
      logger.i('post: (${_editTextController.selection.baseOffset},${_editTextController.selection.extentOffset})'
...
class _EditDataPoint {
  ...
  bool operator ==(other) {
    ...
    return runtimeType == other.runtimeType && location == other.location && _measureEditType == other.measureEditType;
  }

  @override
  int get hashCode => hashValues(location, _measureEditType);
