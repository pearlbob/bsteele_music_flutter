  ...
  Widget build(BuildContext context) {
...

    {
      ...
      //  title row
      {
        ...
        children.add(
          Center(
            child: Text('Drum', style: _boldSmallStyle, textAlign: TextAlign.right),
          ),
        );
      ...
      for (var part in DrumTypeEnum.values) {
        ...
        children.add(
          Center(
            heightFactor: 1.0,
            child: Text(Util.camelCaseToLowercaseSpace(part.name), style: _smallStyle, textAlign: TextAlign.right),
          ),
        );
        ...
        return Column(
          ...
          children: [
            ...
            AppWrapFullWidth(
              spacing: spacing,
              children: [
                Text('Drums:', style: widget._headerStyle),
                AppWrap(
                  children: [
                    //  enter name text
                    AppTextField(
